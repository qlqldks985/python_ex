...
# values(): 딕셔너리에서 벨유값들만 몽땅 뽑는다. 뽑은 벨류들은 리스트와 비슷한 데이터 타입이다.
values = student.values()
print(f'values: {values}')  #dict_valuse)[123456789, '홍길자', 20, 'M']
...
'''
items 튜플 ==> ('학번', 123456789) ==> item[0], item[1]
'''
...
# quiz) 다음은 스포츠 센터 회원 정보를 나타낸 표이다.       '박찬호+25+010-1234-5678+헬스,수영+0
...
# print(f'info: {info}')  # 박찬호+25+010-1234-5678+헬스,수영+0
# infos = info.split('+')
# print(f'infos: {infos}') # ['박찬호', '25', '010-1234-5678', '헬스,수영', '0']    
# members = {
#     '2019-052001': {'이름': '박찬호', '나이': 25, '성별': 'M', '연락처': '010-1234-5678', '이용 서비스': '헬스, 수영', '경로 우대 할인율(%)': 0},
#     '2019-052004': {'이름': '박찬호', '나이': 25, '성별': 'M', '연락처': '010-1234-5678', '이용 서비스': '헬스, 수영', '경로 우대 할인율(%)': 0},
#     '2019-052001': {'이름': '박찬호', '나이': 25, '성별': 'M', '연락처': '010-1234-5678', '이용 서비스': '헬스, 수영', '경로 우대 할인율(%)': 0}
# }
...
연산자
제어문(조건문, 반복문)
컨테이형 자료구조(list, tuple, dictionary)
'''
