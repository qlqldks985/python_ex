# 논리 연산자
# 논리 연삱자는 피연산자의 논리 자료형 (True/False) 을 이용하는 연산자로 and, or, not 이 있습니다.

#and 연산자
# '그리고' 라는 뜻으로,
# 피연산자가 모두 True 인 경우에만 결과가 True 입니다.
...
# not(부정) 연산자
# not 은 '부정'이라는 뜻으로, 피연산자의 현재 상태를 부정하는 연산자입니다.
...
#and , or ,연산시 주의사항
# and 연산자는 모든 피연산자가 True 인 경우에만 결과를 True로 출력하기 때문에
...
# string result = myScore >= targetScore? '합격' : '불합격'
